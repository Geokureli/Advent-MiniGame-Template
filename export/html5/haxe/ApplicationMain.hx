...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TemplateMinigame2022", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TemplateMinigame2022", null, 960, 540);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TemplateMinigame2022";
		app.meta["name"] = "TemplateMinigame2022";
